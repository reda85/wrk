...
export const updateJobByPk = gql`
  mutation updatejob($category: String,$title: String,$type: String, $id : uuid!, $description :String, $application_location : String, $application_phone: String, $application_linkedin : String, $application_github: String) {
