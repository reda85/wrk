...
console.log("user ", user)
    return(
        ...
        <div className="flex flex-col flex-shrink w-64 font-bold p-2  shadow-inner">
           {setup=='details' ? <div className="flex flex-row p-2 justify-between bg-blue-700 text-white cursor-pointer rounded-md" >Job details</div> : <div className="flex flex-row p-2 justify-between hover:bg-blue-50 cursor-pointer rounded-md" onClick={() => router.push(`/jobs/${job.id}/setup/details`)} >Job details</div>}
