        ...
        <div className="flex flex-col font-extrabold flex-shrink w-56 px-4 py-2 shadow-inner  ">
          <p className="font-extrabold text-gray-500 p-2 text-lg ">Stages ({stages?.length})</p>
            ...
            {stages && stages.map(stage => {
               if( (id != stage.id)) { return <button className="flex font-bold flex-row p-2 justify-between hover:bg-blue-50 cursor-pointer rounded-md items-center" onClick={() => selectStage(stage, job)}>
