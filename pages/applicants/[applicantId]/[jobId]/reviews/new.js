  ...
  <div>
     <div className="flex flex-row justify-between align-middle">
       <div className="h-16 p-4 flex flex-Row text-xl font-bold align-middle ">
            <div className="hover:bg-violet-50 cursor-pointer rounded-md p-1" onClick={() => router.back()}><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
    ...
    <div className="flex flex-row">
     <div className="w-1/2 shadow-inner">
        { candidate && 
        <div>
            <div className="mx-6 mt-2 text-violet-800 text-3xl font-extrabold">
